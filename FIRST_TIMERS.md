...
2. __[Fork](https://help.github.com/fork-a-repo/)__ the [smtpapi-go](https://github.com/sendgrid/smtpapi-go) repository:
...
git clone https://github.com/your_username/smtpapi-go
